...
\title{Electrocardiography Arrhythmia Analysis With Maximum Variance Unfolding Manifold Learning}
...
\thanks{xx and L. Wang are with Shenzhen Institutes of Advanced Technology, Chinese Academy of Sciences.}% <-this % stops a space
...
% The paper headers
\markboth{xx}%
{xx \MakeLowercase{\textit{et al.}}: Electrocardiography Arrhythmia Analysis With Semidefinite Embedding Based Manifold Learning}
